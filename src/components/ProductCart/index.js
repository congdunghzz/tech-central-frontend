        ...
        <div className=" col-lg-3 col-md-6">
                    <div className="border border-secondary m-2 mb-2 border-opacity-25">
                        ...
                        <div className="px-4 text-warning">
                            ...
                            <spam className="ranking text-secondary ms-2">4.2</spam>
                        </div>

                        <div className="px-4 d-flex align-items-center pt-3 pb-3">
                            <h4 className="fst-italic text-primary me-5">$1500</h4>
                            <button className="btn custom-btn-pink custom-btn-outline-info fw-bold">
